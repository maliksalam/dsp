...
>> P = P(Identical Twins | Twin Brother) = P(Identical Twins & Twin Brother) / P(Twin Brother)
...
>> Frequentist statistics assumes observed frequencies are the result of a
>> steady data generating model with fixed probabilities for each outcome.

>> Bayesian statistics takes into consideration information about the state
>> the world to make inference also called priors. Also assumes we generally
>> don't know all the priors.
